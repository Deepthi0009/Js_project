...
function changeDirection(direction,steps){
    switch(direction)
    {
       ...
       case "N":temp=queen.position.x;
                ...
                break;
       case  "E":queen.position.y+=steps;
                  console.log("Now your position is "+queen.position.x,queen.position.y);
                  break;       
       case "W" :queen.position.y-=steps;
                   console.log("Now your position is "+queen.position.x,queen.position.y);
                  break;  
       case "NE" :queen.position.x+=steps;
                  queen.position.y+=steps;
                  console.log("Now your position is "+queen.position.x,queen.position.y);
                  break; 
       case "SW":queen.position.x+=steps;
                 queen.position.y-=steps;
                 console.log("Now your position is "+queen.position.x,queen.position.y);
                     break; 
       case "NW":queen.position.x-=steps;
                 queen.position.y-=steps;
                 console.log("Now your position is "+queen.position.x,queen.position.y);
                 break; 
       case "SE" :queen.position.x+=steps;
                  queen.position.y+=steps;
                  console.log("Now your position is "+queen.position.x,queen.position.y);
                  break;  
    default:  console.log("your direction is invalid ....please enter valid diretion")
    }
}
